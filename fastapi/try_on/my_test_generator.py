...
def get_opt():
    ...
    parser.add_argument("--dataroot", default="C:\\Users\\hi\\PycharmProjects\\hr-vton-pipline\\fastapi\\data")
    parser.add_argument("--datamode", default="test")
    parser.add_argument("--data_list", default="test_pairs.txt")
    parser.add_argument("--output_dir", type=str, default=".\\output\\viton")
    ...
    parser.add_argument('--checkpoint_dir', type=str,
                        default='C:\\Users\\hi\\PycharmProjects\\hr-vton-pipline\\fastapi\\try_on\\checkpoints',
                        help='save checkpoint infos')
    # parser.add_argument('--tocg_checkpoint', type=str,
    #                     default='C:\\Users\\hi\\PycharmProjects\\hr-vton-pipline\\fastapi\\try_on\\eval_models\\v0.1\\tocg_final.pth',
    #                     help='tocg checkpoint')
    # parser.add_argument('--gen_checkpoint', type=str,
    #                     default='C:\\Users\\hi\\PycharmProjects\\hr-vton-pipline\\fastapi\\try_on\\eval_models\\v0.1\\D_final.pth',
    #                     help='G checkpoint')
    parser.add_argument('--tocg_checkpoint', type=str,
                        default='C:\\Users\\hi\\PycharmProjects\\hr-vton-pipline\\fastapi\\try_on\\eval_models\\v0.1\\mtviton.pth',
                        help='tocg checkpoint')
    parser.add_argument('--gen_checkpoint', type=str,
                        default='C:\\Users\\hi\\PycharmProjects\\hr-vton-pipline\\fastapi\\try_on\\eval_models\\v0.1\\gen.pth',
                        help='G checkpoint')
...
def my_toto(opt, test_loader, tocg, generator):
    ...
    if opt.output_dir is not None:
        ...
        output_dir = os.path.join('./output', 'viton')
    ...
    print(f"VITON time is {round(time.time() - iter_start_time)}sec")
...
def main():
    ...
    # Train
    my_toto(opt, test_loader, tocg, generator)
